<?php
/**
 * audiocafe.tokyo/rakuten-mobile/index-ch.php — Schweiz.
 * Die Schweiz hat vier Amtssprachen (Deutsch/Französisch/Italienisch/
 * Rätoromanisch); Deutsch ist die am weitesten verbreitete Sprache,
 * daher verwendet diese Seite gemäß Projektkonvention ebenfalls die
 * deutsche Übersetzung (index-de.php) als repräsentative Variante,
 * analog zur selben Konvention wie bei index-at.php — keine
...
<body>
<main>
  <?php $current = 'ch'; include __DIR__ . '/lang-nav.php'; ?>
