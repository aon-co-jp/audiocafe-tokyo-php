<?php
/**
 * audiocafe.tokyo/rakuten-mobile/index-en.php — English adaptation.
...
<meta name="description" content="Rakuten Mobile 'Rakuten Saikyo Plan' pricing, coverage areas, international calling, platinum band, and satellite broadband — English overview.">
...
<body>
<main>
  <?php $current = 'en'; include __DIR__ . '/lang-nav.php'; ?>

  <h1>📶 Rakuten Mobile — Latest Info</h1>
  <p class="muted">Combining Rakuten's own network coverage area with the au partner-network roaming area gives you unlimited data (data unlimited) nationwide.</p>
  ...
  <div class="card">
    ...
    <p>Unlimited monthly data for as low as <span class="price">Up to ¥3,278<span> (tax included)</span></span></p>
    <p class="muted">Prices and figures shown here are indicative. For the always-current, auto-updated (daily 05:00 AM JST) cached values, see the <a href="/rakuten-mobile/">Japanese page</a>, or check the official site directly.</p>
  ...
  <div class="card">
    ...
    <p>Underground, in high-rise buildings, or in deep indoor spaces, the signal can be harder to reach. Rakuten is expanding its platinum band (700MHz) to improve this.</p>
  </div>

  <h2>🗺️ Coverage-check tools</h2>
  <p>
    ...
    <a href="https://network.mobile.rakuten.co.jp/faq/detail/00001549/" target="_blank" rel="noopener noreferrer" class="btn btn-blue">❓ What is the "unlimited high-speed data" area?</a>
  </p>
  ...
  <div class="card">
    ...
    🌍 Countries covered by the unlimited plan: approx. <strong>66 countries</strong><br>
    ✈️ Overseas → Japan: free when using the Rakuten Link app (conditions apply, eligible countries only)</p>
    <p><strong>🌏 Can you really call Japan for free from overseas too?</strong><br>
    Yes — mainly when using the Rakuten Link app (conditions apply).</p>
    <ul>
      <li>Japan → Japan: free via Rakuten Link</li>
      <li>Japan → overseas: covered by "International Unlimited Calling" (¥980/month) for ~66 countries</li>
      <li>Overseas → Japan: free via Rakuten Link (from eligible countries)</li>
    </ul>
    <p class="muted">Notes: Rakuten Link must be authenticated in Japan before traveling overseas · only supported countries/regions apply · Wi-Fi may be required in some regions · some numbers (0570/0120 etc.) are excluded · iPhone behavior overseas differs slightly from Android · this works as IP calling via the Rakuten Link app.</p>
  ...
  <div class="card">
    ...
    <p class="muted">Low-earth-orbit (LEO) satellites are expected to enable calls and data connectivity from ordinary smartphones even in remote mountains, isolated islands, and offshore areas.</p>
    <p class="muted">🛰️ Commercial launch: TBD (some reports suggest a 2025–2026 target)</p>
  </div>
  ...
  <div class="card">
    ...
    <p class="muted">📶 Coverage: nationwide rollout in progress (expanding in phases)</p>
  </div>

  <h2>📶 Switching to Rakuten Mobile (¥1 phones, unlimited data, unlimited calls)</h2>
  <div class="card">
    <p>If you're considering switching, campaigns sometimes offer eSIM-compatible devices — such as Fujitsu's high-performance "we2 plus" — for as little as <strong>¥1</strong> (availability, timing, and contract conditions vary — always confirm current terms). The <strong>Rakuten Link</strong> app is available nationwide across Japan.</p>
    <ul>
      <li><a href="https://www.google.com/search?q=%E6%A5%BD%E5%A4%A9%E3%83%A2%E3%83%90%E3%82%A4%E3%83%AB+%E3%81%8A%E5%8B%A7%E3%81%828+1%E5%86%86+%E9%AB%98%E6%80%A7%E8%83%BDCPU+%E5%AF%8C%E5%A3%AB%E9%80%9A%E8%A3%BD%E3%81%AE%E3%82%B9%E3%83%9E%E3%83%9B+we2+plus" target="_blank" rel="noopener noreferrer">Example ¥1 phones: Fujitsu "we2 plus" and others (verify current offer)</a></li>
      ...
      <li><a href="https://www.google.com/search?q=%E6%A5%BD%E5%A4%A9%E3%83%A2%E3%83%90%E3%82%A4%E3%83%AB+%E4%B9%97%E3%82%8A%E6%8F%9B%E3%81%88+%E3%82%AD%E3%83%A3%E3%83%B3%E3%83%9A%E3%83%BC%E3%83%B3" target="_blank" rel="noopener noreferrer">Switching campaigns (general)</a></li>
    </ul>
    <p class="muted">In areas with good Rakuten Mobile coverage, a plan with less concern for data caps can be handy for streaming or video chat. Where hospitals and similar facilities offer free Wi-Fi, this can also help while at home or during a hospital stay (always confirm plan details and coverage on the official site).</p>
  </div>

  <p><a href="/rakuten-mobile/#aruaru-top80-tech">→ See the always-current cached figures on the Japanese page</a></p>
  ...
  <footer>
    ...
    <p style="margin-top:4px;">Rakuten Mobile info is auto-crawled and updated daily at 05:00 AM JST. Always confirm details on the <a href="https://network.mobile.rakuten.co.jp/fee/saikyo-plan/" target="_blank" rel="noopener noreferrer">official site</a>.</p>
  </footer>
</main>
</body>
</html>
